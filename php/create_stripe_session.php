...
$success_url = 'http://localhost/kyoshi/php/stripe_success.php?session_id={CHECKOUT_SESSION_ID}&booking_ids=' . implode(',', $booking_ids) . '&is_partial=' . ($is_partial ? '1' : '0') . '&original_payment=' . $original_payment_id;
